...
contract ERC721 {
  ...
  * @param _tokenId uint256 the id of the token the operator is being granted rights to.
  */
  ...
  * @param _approved bool true if the operators is approved, false to revoke approval.
  */
